...
7. Meting alleen op de vaste meetdag — donderdag (gewicht + vet%; besluit gebruiker aug 2026, eerst zaterdag); de grafiek toont de trend; de 4-weken-evaluatie geeft een súggestie (gemiddelde ≥0,4 kg/wk → niets doen; lager terwijl weken binnen waren → "overweeg −200 kcal, één knop") — de app beslist nooit zelf.
...
4. Voortgang — dashboard met donut-meters (vet% voorop, gewicht ernaast; doelen instelbaar, voortgang van eerste meting naar doel), weekmeting (donderdag) invoeren, metingenlijst met per meting gewicht in kg, vet%, vetmassa in kg en de verschillen t.o.v. de vorige meting (vetverschil telt tegen de vorige meting mét vet%), trendlijnen voor gewicht, vetmassa en vet% met as-labels, richtwaardenkaart (gezonde BMI-gewichtsband en leeftijdsgecorrigeerde vetbanden in % en kg, instelbare lengte/leeftijd; richtlijn, geen oordeel), droge-dagen-reeks, 4-weken-evaluatiekaart met de suggestieregel, export/import-reservekopie.
