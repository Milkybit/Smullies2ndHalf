...
6. De app telt géén calorieën per maaltijd. Het schema ís de waarheid: de app toont de standaarddag (vast ontbijt/lunch/snack, gedekt door de vaste weeklijst), het diner van vandaag (rotatie week 1-4) en het plus-blok. Geen invoervelden voor eten. Kook_factor 2: elk rotatiegerecht staat standaard op 2 dagen (1× koken = 2× eten). Zaterdagse tafel: zaterdagavond geen rotatiegerecht en geen boodschappen (vieren-budget). Het definitieve plan staat in plan/doel1-plan.json — dat bestand is de bron; de seed volgt het plan.
...
3. Eten — standaarddag-kaart (vast, uit het plan), diner-weekmenu per dag te kiezen uit de 12 gerechten met porties-teller (rotatievoorstel: elk gerecht op 2 dagen, za vrij; herstelknop), gerechtkaarten met formule + bereiding, knop "boodschappenlijst maken" (vaste weeklijst + diner-ingrediënten × porties, samengevoegd; "naar smaak"-items één keer ongeteld), afvinkbaar in de winkel, rekent live mee met menuwijzigingen. (Eerdere per-dag ontbijt/lunch/snack-keuze verving door de standaarddag toen het definitieve plan werd aangeleverd, aug 2026.)
